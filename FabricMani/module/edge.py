...
from FabricMani.module.models import GNN
...
from FabricMani.utils.camera_utils import get_matrix_world_to_camera, project_to_image
import matplotlib.pyplot as plt
import torch_geometric

from FabricMani.module.dataset_edge import ClothDatasetPointCloudEdge
from FabricMani.utils.utils import extract_numbers
from FabricMani.utils.data_utils import AggDict
import json
...
class Edge(object):
    def __init__(self, args, env=None):
        ...
        if self.args.use_wandb and args.eval == 0:
            ...
            wandb.init(project='FabricMani', entity='yanglh14', name=args.exp_name, resume='allow',
    ...
    def load_data_and_predict(self, rollout_idx, timestep, dataset):
        ...
        if rollout_idx ==0:
            ...
            idx = dataset.cumulative_lengths[rollout_idx - 1] + timestep
