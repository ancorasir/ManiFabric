...
from FabricMani.utils.utils import extract_numbers, pc_reward_model, visualize, cloth_drop_reward_fuc, save_numpy_as_gif
...
class Dynamic(object):
    def __init__(self, args, env, edge=None):
        ...
        print("FabricMani dynamics models created")
        ...
        print("FabricMani datasets created")
