...
from FabricMani.real_robot.scripts.robot import Robot
from FabricMani.real_robot.scripts.rs_camera import RSListener
...
class EnvReal:
    ...
    def get_ee_pose(self):
        ...
        return np.array([ee_right[0], ee_left[0]])
