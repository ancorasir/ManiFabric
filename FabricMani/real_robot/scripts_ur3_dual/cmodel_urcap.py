...
class RobotiqCModelURCap:
    ...
    def rq_is_gripper_activated(self):
        ...
        # print(f"self._get_var(self.STA): {self._get_var(self.STA)}")
        # print(self._get_var(self.STA) == ('3').encode())
        return self._get_var(self.STA) == ('3').encode()
    def rq_reset(self):
        """Reset the gripper."""
        ...
        # return self._set_var(self.ACT, 0)
    ...
    def activate(self, auto_calibrate):
        ...
        print(f"self._set_var(self.STA, 0): {self._set_var(self.STA, 0)}")
        print(f"self._set_var(self.STA, 1): {self._set_var(self.STA, 1)}")
    ...
    def move_and_wait_for_pos(self, position, speed, force):
        ...
        cur_obj = int(self._get_var(self.OBJ))
...
if __name__ == '__main__':
    # gripper = Gripper2f85()
    gripper = RobotiqCModelURCap('10.2.0.50')
    ...
    gripper._set_var(gripper.ACT,0)
    time.sleep(1)
    gripper._set_var(gripper.ATR,0)
    time.sleep(1)
    print(gripper._get_var(gripper.ACT))
    print(gripper._get_var(gripper.ATR).hex())

    gripper._set_var(gripper.ACT,1)
    time.sleep(1)
    print(gripper._get_var(gripper.ACT))
    ...
    # gripper.move_and_wait_for_pos(255, 255, 255)
    # gripper.move_and_wait_for_pos(0, 255, 255)
    print(gripper._get_var(gripper.SPE))
    print(gripper._get_var(gripper.FOR))
    print(gripper._get_var(gripper.POS))

    # gripper._set_var(gripper.GTO, 0)
    # print(gripper._get_var(gripper.GTO))
    
    # gripper._set_var(gripper.POS, 0)
    # gripper._set_var(gripper.GTO, 1)
    time.sleep(1)
    print(gripper._get_var(gripper.POS))
    print(gripper._get_var(gripper.GTO))